...
public class AuthController {
    ...
    public ApiResponse<UserResponse> me(@AuthenticationPrincipal UserPrincipal principal) {
        return ApiResponse.success("Current user", authService.me(principal));
    }
    ...
    public ApiResponse<UserResponse> changePassword(
        ...
        return ApiResponse.success("Password updated", authService.changePassword(principal, request));
    }

    @PostMapping("/register")
    public ApiResponse<AuthResponse> register(@Valid @RequestBody RegisterRequest request) {
        return ApiResponse.success("User created", authService.register(request));
    }

    @PostMapping("/users/{userId}/activate")
    public ApiResponse<UserResponse> activate(@PathVariable Long userId) {
        return ApiResponse.success("User activated", authService.activate(userId));
    }

    @PostMapping("/users/{userId}/deactivate")
    public ApiResponse<UserResponse> deactivate(@PathVariable Long userId) {
        return ApiResponse.success("User deactivated", authService.deactivate(userId));
    }
}